...
class InvalidFromRouteSearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_invalid_from_route_search(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//nav[@id='sidebar']/div[9]/form/div/p").click()
        ...
        driver.find_element_by_xpath(u"(//a[contains(text(),'×')])[4]").click()
