...
class InvalidToRouteSearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_invalid_to_route_search(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//nav[@id='sidebar']/div[9]/form/div[2]/p").click()
        driver.find_element_by_id("findroute").click()
        driver.find_element_by_xpath(u"(//a[contains(text(),'×')])[5]").click()
